 ...
 * @author adrian
 */
public class VAcademia extends javax.swing.JDialog {
   
    public VAcademia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("OPERACIONES PARA LAS ACADEMIAS");
        ...
        jLabel8.setText("Clave de la academia:");

        btnBuscar.setBackground(new java.awt.Color(98, 17, 50));
        ...
        btnNuevo.setBackground(new java.awt.Color(98, 17, 50));
